...
public class PiecewiseLerpTest {
    ...
    /**
     * Test method for
     * {@link supergame.networking.PiecewiseLinearInterpolator#addSample(double, float[])} .
     */
    @Test
    public void testAddSample() {
        for (int i = 0; i < samples.length; i++)
            assertTrue(mInterp.addSample(i, samples[i]));
        assertFalse(mInterp.addSample(-100, new float[] {
                0, 0
        }));
    }
    ...
    /**
     * Test method for
     * {@link supergame.networking.PiecewiseLinearInterpolator#sample(double, float[])} .
     */
    @Test
